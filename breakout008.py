...
class Paddle(pygame.sprite.Sprite):
    ...
    def expand(self, duration=300):
        ...
        if not self.expanded:
            ...
            self.width = min(int(self.width * 1.5), SCREEN_WIDTH - 20)  # Ensure paddle doesn't exceed screen
            self.image = pygame.Surface([self.width, self.height])
...
class Brick(pygame.sprite.Sprite):
    ...
    def explode(self):
        ...
        for brick in adjacent_bricks:
            ...
            # Optionally, add explosion effects or score increments here
...
def apply_powerup(power_type):
    ...
    if power_type == 'expand_paddle':
        ...
        new_balls = []
        for ball in balls.copy():
            # Create two new balls with slightly altered speeds and no speed_increment
